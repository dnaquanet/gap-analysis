...
OldGap = "OldData/MaFi_GapOld.txt"
ProgFolder = "progressReports"
Kingdom = "Animals"
BoldDaset = "rawdata/MaFi"

outputGap = "NewData/MaFi_Gap.txt"
outputRT = "NewData/MaFi_Gap_RT.txt"
outputRTT = "RT/MaFi_RT_Overview.txt"
...
"molecular approach","dna barcode 99.69% match","by dna sequence","dna barcode blast","dna barcode 100% match","bold id engine and genbank","bin taxonomy match and specimen image","molecular identification","molecular: coi","barcoding","dna barcoding cop-5p","bin rep taxon id tree","bold specimen identification request","bold barocde library","molecular",
"genetic similarity","coi","bold assignment","molecular id","genetic","id engine"]
