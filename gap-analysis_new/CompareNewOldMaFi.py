...
old = "OldData/MaFi_GapOld.txt"
new = "NewData/MaFi_Gap.txt"
...
GroupswChanges(infoN,dataN,dataO,"results","MaFi_DataGroups",1)
GroupswChanges(infoN,dataN,dataO,"results","MaFi_DataGroups",5)
