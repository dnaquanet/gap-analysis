...
thresh = 500
list1 = "MaAmis.txt"
pyhlum = ["Arthropoda","Annelida","Mollusca","Chordata","Brachiopoda","Cnidaria",
"Echinodermata","Nemertea","Priapulida","Sipuncula","Bryozoa","Platyhelminthes",
"Porifera","Entoprocta","Phoronida","Chaetognatha","Xenacoelomorpha"]
marker="COI-5P"
...
for gen in ["Cliona","Craniella","Halichondria","Leptoplana","Pedicellina","Phoronis","Spadella","Xenoturbella"]:
   g += 1
   v = testDataPresent(gen)
   if  v > 0:
